<template>
    <v-app>
        ...
        <div v-else>
            <Nav />
            <!-- Page 1 -->
            <v-carousel :continuous="false" cycle :show-arrows="false" :height="height + 200" hide-delimiter-background
                delimiter-icon="mdi-minus">
                <v-carousel-item v-for="(p, i) in slides" :key="'car1'+i">
                    <v-img :height="height + 200" :src="'./images/home/slides/'+p.image">
                        <v-container v-show="nosm">
                            <v-row>
                                <v-col>
                                    <p class="display-1 font-weight-black mt-10 text-uppercase white--text"
                                        :class="row(i)">
                                        {{ p.title }}
                                    </p>
                        ...
                        <v-container v-show="sm">
                            <v-row>
                                <v-col md="12">
                                    <p class="font-weight-black text-uppercase text-center white--text">
                                        {{ p.title }}
                                    </p>
                                    <p class="display-2 text-uppercase white--text font-weight-bold">
                                        {{ p.subtitle }}
                                    </p>
            ...
            <!-- Page 2 -->
            <v-content
                style="background-image: url(https://agriwell.com/wp-content/uploads/2019/05/biodynamic-1.png); background-color: #262b2b;">
                <v-container>
                    <div class="d-flex justify-center" v-show="nosm">
                        <v-card v-for="(img, idx) in images_slides" :key="'imgslide'+idx" class="mx-6 mt-n16"
                            v-show="nosm">
                            <v-img :src="'./images/home/images_slides/'+img.image" max-width="250"></v-img>
                        </v-card>
                    </div>
                    <div v-if="nosm">
                        <v-row v-for="(pg2, i) in page2" :key="'pg2_1'+i">
                            <v-col cols="4">
                                <p class="font-weight-bold display-4 white--text">{{ pg2.title }}</p>
                            </v-col>
                            <v-col cols="2"></v-col>
                            <v-col cols="6">
                                <p class="font-weight-light text-h5 white--text mt-10">{{ pg2.subtitle }}</p>
                    ...
                    <v-row>
                        <v-col md="6">
                            <div :class="nosm ? 'mr-12' : '' ">
                                <v-img src="https://agriwell.com/wp-content/uploads/2020/05/home-farmers.png"
                                    :height="height"></v-img>
                            </div>
                        </v-col>
                        <v-col md="6">
                            ...
                            <v-row>
                                <v-col md="6" v-for="(sub, i) in sub_page3" :key="'sub_page3'+i">
                                    ...
                                    <p class="font-weight-regular mt-5" :class="sm ? 'text-h5' : 'display-1'">
                                        {{ sub.title }}</p>
                                    <p class=" font-weight-thin text--secondary" :class="sm ? '' : 'text-h5'">
                                        {{ sub.subtitle }}</p>
                                </v-col>
                            </v-row>
            ...
            <!-- Page 3 -->
            <v-content
                style="background-image: url(https://agriwell.com/wp-content/uploads/2019/05/services2.png); background-color: #262b2b;">
                <v-container>
                    <v-row class="my-16">
                        <v-col>
                        ...
                        <v-col>
                            <v-row>
                                <v-col md="4" v-for="(sub, i) in services" :key="'sub_page3'+i">
                                    ...
                                    <p class="font-weight-regular mt-5 white--text text-center text-h5">{{ sub.title }}
                                    </p>
                                </v-col>
                            </v-row>
                        </v-col>
            ...
            <v-content style="background-color: #f4f4f4;">
                <v-container class="py-16">
                    <div :class="nosm ? 'd-flex flex-wrap-reverse' : ''" v-if="nosm">
                        <v-card class="rounded-circle mt-16 mx-auto transition-swing success"
                            :height="nosm ? '200' : '100'" :width="nosm ? '20%' : '30%'" v-for="(prg, idx) in progress"
                            :key="'prg'+idx">
                            <v-card-title class="white--text justify-center mt-12"
                                :class="nosm ? 'display-3' : 'h5-text pt-8'">
                        ...
                        <v-col cols="12" v-for="(prg2, idx) in progress" :key="'prg2'+idx" class="text-center">
                            <div class="d-flex justify-center">
                                <v-card class="rounded-circle success" height="100" width="30%">
                                    <v-card-title class="white--text justify-center mt-5"
                                        :class="nosm ? 'display-3' : 'h5-text '">
            ...
            <v-content>
                <v-container>
                    <v-row class="my-16">
                                ...
                                <v-col cols="12" v-for="(sub, i) in sub_page5" :key="'sub_page5'+i">
                                    <v-row>
                                        ...
                                        <v-col>
                                            ...
                                            <p class="font-weight-regular" :class="sm ? 'text-h5' : 'display-1'">
                                                {{ sub.title }}</p>
                                            <p class=" font-weight-thin text--secondary" :class="sm ? '' : 'text-h5'">
                                                {{ sub.subtitle }}</p>
                                        </v-col>
                        ...
                        <v-col class="pr-5">
                            <v-img src="https://agriwell.com/wp-content/uploads/2020/05/home-earth.png"
                                :height="height"></v-img>
                        </v-col>
                    </v-row>
                </v-container>
            ...
            <!-- Page 6 -->
            <v-content
                style="background-image: url(https://agriwell.com/wp-content/uploads/2019/05/people-say.png); background-color: #262b2b;">
                ...
                <v-container>
                    <v-row class="my-16" v-if="nosm">
                        <v-col cols="4">
                            ...
                            <div v-for="(latest, i) in news_latest" :key="'page7_1'+ i">
                                <v-img :src="'./images/home/news/'+latest.image" :height="height - 300"></v-img>
                        ...
                        <v-col cols="8">
                            <p class="font-weight-light title" v-for="(disp, i) in page7" :key="'page7'+ i"
                                v-text="disp.subtitle"></p>
                            <v-row>
                                <v-col cols="6" v-for="(disp, i) in news_latest_2" :key="'page7_2'+i">
                                    <div v-if="disp.number != 1">
                                        <v-img :src="'./images/home/news/'+disp.image" :height="height - 400"></v-img>
                    ...
                    <v-row class="my-16" v-if="sm">
                        ...
                        <v-col cols="12" v-for="(nw, i) in news" :key="'page7-2'+i">
                            <v-img :src="'./images/home/news/'+nw.image" :height="height"></v-img>
